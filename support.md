...
<p>「設定」>「プライバシーとセキュリティ」>「ヘルスケア」>「PDAI」から、必要なヘルスケアデータ（歩数、心拍数、睡眠）へのアクセスを許可してください。許可後、アプリを再起動するとデータが反映されます。</p>
</details>

<details>
<summary>AI応答が遅い場合はどうすればよいですか？</summary>
<p>PDAIはオンデバイスAI（Apple Foundation Models）を優先的に使用します。クラウドAI（Gemini API）使用時は、ネットワーク接続状況により応答速度が変わる場合があります。Wi-Fi環境でのご利用を推奨します。</p>
</details>
...
<p>PDAIのデータはiCloudバックアップに含まれます。iPhoneの「設定」>「Apple ID」>「iCloud」>「iCloudバックアップ」が有効になっていることをご確認ください。</p>
</details>
